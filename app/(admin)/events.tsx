...
function statusPillColors(status: FightStatus): { bg: string; fg: string; label: string } {
  switch (status) {
    case 'scheduled':
      return { bg: 'rgba(59,130,246,0.15)', fg: '#1e3a8a', label: 'Scheduled' }; // blue-ish
    case 'completed':
      return { bg: 'rgba(16,185,129,0.15)', fg: '#065f46', label: 'Completed' }; // green-ish
    case 'cancelled':
      return { bg: 'rgba(239,68,68,0.15)', fg: '#7f1d1d', label: 'Cancelled' }; // red-ish
    case 'pending':
    default:
      return { bg: 'rgba(234,179,8,0.16)', fg: '#713f12', label: 'Pending' }; // amber-ish
  }
}
